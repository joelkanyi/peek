...
internal class ProtoTestWriter {
    ...
    fun varintField(field: Int, value: Long): ProtoTestWriter = apply {
        tag(field, 0)
        varint(value)
    }
    fun i32Field(field: Int, bits: Int): ProtoTestWriter = apply {
        tag(field, 5)
        buffer.writeIntLe(bits)
    }
    fun i64Field(field: Int, bits: Long): ProtoTestWriter = apply {
        tag(field, 1)
